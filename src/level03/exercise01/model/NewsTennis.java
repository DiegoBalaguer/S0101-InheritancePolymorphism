...
public class NewsTennis extends News {
    ...
    protected int getPointsBase() {
        return TablesPricesPoints.loadPointsBaseTennis();
    }

    @Override
    protected ArrayList<PointsTable> getPointsTables() {
        return TablesPricesPoints.loadTablePointsTennis();
    }

    @Override
    protected double getPriceBase() {
        return TablesPricesPoints.loadPriceBaseTennis();
    }

    @Override
    protected ArrayList<PricesTable> getPricesTables() {
        return TablesPricesPoints.loadTablePricesTennis();
    }
