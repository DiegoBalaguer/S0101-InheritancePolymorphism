...
public class NewsF1 extends News {
    ...
    protected int getPointsBase() {
        return TablesPricesPoints.loadPointsBaseF1();
    }

    @Override
    protected ArrayList<PointsTable> getPointsTables() {
        return TablesPricesPoints.loadTablePointsF1();
    }

    @Override
    protected double getPriceBase() {
        return TablesPricesPoints.loadPriceBaseF1();
    }

    @Override
    protected ArrayList<PricesTable> getPricesTables() {
        return TablesPricesPoints.loadTablePricesF1();
    }
